...
Este repositorio contiene las aplicaciones desarrolladas como parte del **Trabajo Práctico N°1** en la materia **Programación 2**, centradas en la simulación y modelado de herramientas básicas utilizando Java.  
...
#### **Ejercicio [4] – Determinación de Trimestres**  
- **Descripción:** Según una fecha ingresada (día, mes, año), identifica a qué trimestre del año pertenece el mes.  

#### **Ejercicio [5] – Cuadrante de un Punto en un Plano Cartesiano**  
- **Descripción:** Determina en qué cuadrante del plano cartesiano se encuentra un punto basado en sus coordenadas (x, y).  

#### **Ejercicio [6] – Análisis de Triángulos**  
- **Descripción:** Clasifica varios triángulos según las longitudes de sus lados como:  
  - Equilátero.  
  - Isósceles.  
  - Escaleno.  
Además, lleva un contador para cada tipo de triángulo.
